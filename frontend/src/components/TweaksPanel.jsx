...
const TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:16px;z-index:9999;width:280px;
    ...
    background:rgba(12,20,36,.94);color:#d8e6f4;
    -webkit-backdrop-filter:blur(24px) saturate(160%);backdrop-filter:blur(24px) saturate(160%);
    border:.5px solid rgba(255,255,255,.1);border-radius:14px;
    box-shadow:0 1px 0 rgba(255,255,255,.06) inset,0 12px 40px rgba(0,0,0,.6);
    font:11.5px/1.4 'Space Grotesk',ui-sans-serif,system-ui,sans-serif;overflow:hidden}
  .twk-hd{display:flex;align-items:center;justify-content:space-between;
    padding:10px 8px 10px 14px;cursor:move;user-select:none;border-bottom:.5px solid rgba(255,255,255,.06)}
  .twk-hd b{font-size:12px;font-weight:600;letter-spacing:.01em}
  .twk-x{appearance:none;border:0;background:transparent;color:rgba(216,230,244,.45);
    width:22px;height:22px;border-radius:6px;cursor:pointer;font-size:13px;line-height:22px}
  .twk-x:hover{background:rgba(255,255,255,.08);color:#d8e6f4}
  ...
  .twk-lbl{display:flex;justify-content:space-between;align-items:baseline;color:rgba(216,230,244,.65)}
  .twk-lbl>span:first-child{font-weight:500}
  .twk-val{color:rgba(216,230,244,.4);font-variant-numeric:tabular-nums}
  .twk-sect{font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;
    color:rgba(216,230,244,.38);padding:6px 0 0}
  ...
  .twk-slider::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;width:14px;height:14px;
    border-radius:50%;background:#d8e6f4;border:.5px solid rgba(255,255,255,.2);
    box-shadow:0 1px 3px rgba(0,0,0,.4);cursor:pointer}
  .twk-slider::-moz-range-thumb{width:14px;height:14px;border-radius:50%;
    background:#d8e6f4;border:.5px solid rgba(255,255,255,.2);box-shadow:0 1px 3px rgba(0,0,0,.4)}
  .twk-seg{position:relative;display:flex;padding:2px;border-radius:8px;
    background:rgba(255,255,255,.07);user-select:none}
  ...
  .twk-toggle{position:relative;width:32px;height:18px;border:0;border-radius:999px;
    background:rgba(255,255,255,.15);transition:background .15s;cursor:pointer;padding:0;flex-shrink:0}
  .twk-toggle[data-on="1"]{background:#34c759}
  .twk-toggle i{position:absolute;top:2px;left:2px;width:14px;height:14px;border-radius:50%;
    background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.35);transition:transform .15s;display:block}
  .twk-toggle[data-on="1"] i{transform:translateX(14px)}
  .twk-btn{appearance:none;height:26px;padding:0 12px;border:0;border-radius:7px;
    background:rgba(255,255,255,.88);color:#07090e;font:inherit;font-weight:500;cursor:pointer}
  .twk-btn:hover{background:#fff}
  .twk-btn.secondary{background:rgba(255,255,255,.08);color:inherit}
  .twk-btn.secondary:hover{background:rgba(255,255,255,.13)}
`;
